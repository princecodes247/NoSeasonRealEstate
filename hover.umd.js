            ...
            if (r)
                if (a && s && o) {
                    ...
                    var C = new e.ShaderMaterial({
                        ...
                        D = new e.Mesh(b, C);
                    x.add(D), g && (r.addEventListener("mouseenter", ()=>{}), r.addEventListener("touchstart", ()=>{}), r.addEventListener("mouseleave", ()=>{}), r.addEventListener("touchend", ()=>{})), window.addEventListener("resize", function(t) {
